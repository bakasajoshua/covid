...
class Covid
{
    ...
    {
        $tables = ['results', 'receivedstatus', 'covid_justifications', 'covid_sample_types', 'covid_symptoms', 'covid_test_types', 'health_statuses', 'identifier_types', 'observed_signs', 'underlying_conditions', 'nationalities'];
