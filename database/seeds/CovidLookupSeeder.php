...
class CovidLookupSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		DB::table('quarantine_sites')->insert([
			...
			['id' => 74, 'name' => 'Whiskey stream', 'email' => ''],
			['id' => 75, 'name' => 'Lisbon Cafe', 'email' => ''],
			['id' => 76, 'name' => 'Havana', 'email' => ''],
			['id' => 77, 'name' => 'Bluu Nile Hotel Kisii', 'email' => ''],
			['id' => 78, 'name' => 'Scoops & Smiles Ice Cream', 'email' => ''],
			['id' => 79, 'name' => 'Coffee Shop Kisii', 'email' => ''],
			['id' => 80, 'name' => 'Befries', 'email' => ''],
			['id' => 81, 'name' => 'Diplozz Resort', 'email' => ''],
			['id' => 82, 'name' => 'Wind Park', 'email' => ''],
