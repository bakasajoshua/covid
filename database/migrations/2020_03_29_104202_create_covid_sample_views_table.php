...
class CreateCovidSampleViewsTable extends Migration
{
    ...
    {        
        ...
        (
          SELECT s.*, p.facility_id, p.case_id, p.identifier_type, p.identifier, p.patient_name, p.email_address, p.phone_no, p.occupation, p.justification, p.county, p.subcounty, p.ward, p.residence, p.hospital_admitted, p.dob, p.sex, p.current_health_status, p.date_symptoms, p.date_admission, p.date_isolation, date_death, date_recovered, p.county_id, `f`.`facilitycode`,`f`.`name` as facilityname
